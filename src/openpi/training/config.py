...
# [COPILOT] pi05 task-aware config (Q-Former-based VGGT alignment).
    ...
    TrainConfig(
        ...
        taskaware_qformer_layers=6,  # [COPILOT] PoC speed setting: use a smaller 2-block TaskAware Q-Former.
        taskaware_qformer_heads=8,
        taskaware_qformer_mlp_ratio=4.0,
        taskaware_qformer_dropout=0.0,
        taskaware_qformer_cross_attention_freq=2,  # [COPILOT] PoC apply query-VGGT cross-attention every layer.
        ...
        use_vlm_norm=True,
        align_loss_coeff=0.5,
        taskaware_stage1_steps=10_000, # [COPILOT] Stage 1: task-aware only.
        taskaware_stage2_steps=20_000, # [COPILOT] Stage 2: action + align only.
        taskaware_stage3_steps=5_000, # [COPILOT] Stage 3: action + align + task-aware.
        ...
        taskaware_stage23_lr_warmup_steps=1_250, # [COPILOT] Stage 2/3 LR schedule.
    ...
    TrainConfig(
        ...
        save_interval=2000,
        batch_size=16, # [COPILOT] Gradient accumulation is 2
        gradient_checkpointing=True,
        ema_decay=None,
        wandb_enabled=True,
    ),
    ...
    TrainConfig(
        ...
        num_train_steps=20000,
        save_interval=2000,
        batch_size=32, # [COPILOT] Gradient accumulation is off
        gradient_checkpointing=True,
        ema_decay=None,
        wandb_enabled=True,
    ),
